...
HARDCODED_INCIDENTS = [
    {"case_id": "INC001", "title": "Payment Service Timeout Storm"},
    {"case_id": "INC002", "title": "Database Connection Pool Exhaustion"},
    {"case_id": "INC003", "title": "Memory Leak Under Load"},
    {"case_id": "INC004", "title": "Third-Party API Failure"},
    {"case_id": "INC005", "title": "Config Deployment Error"},
    {"case_id": "INC006", "title": "Multi-Region CDN Misrouting"},
    {"case_id": "INC007", "title": "CrowdStrike-Scale Global Failure"},
]
...
def fetch_incidents() -> List[Dict]:
    """Fetch incidents from backend, fallback to hardcoded list."""
    try:
        response = requests.get(f"{API_BASE}/incidents", timeout=3)
